...
require (
	...
	github.com/kyma-incubator/compass/components/connector v0.0.0-20221215143504-2a9f70d0962f
	github.com/kyma-incubator/compass/components/director v0.0.0-20221215143504-2a9f70d0962f
